...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
    ...
    function J(a, b, c) { a._hungarianMap || $(a); var d;
    ...
    function hb(a) { A(a, "orderable", "bSortable");
        ...
        A(a, "orderDataType", "sortDataType"); var b = a.aDataSort; "number" === typeof b && !Array.isArray(b) && (a.aDataSort = [b]) }
    ...
    function ca(a, b) { var c = na(a, "bVisible"),
    ...
    function Ia(a) {
        ...
        for (f = b.length; e < f; e++)
            ...
            g =
                0;
            for (j = d.length; g < j; g++) { i = 0; for (h = c.length; i < h; i++) { s[i] === k && (s[i] = B(a, i, e, "type"));
                    q = d[g](s[i], a); if (!q && g !== d.length - 1) break; if ("html" === q) break } if (q) { m.sType = q; break } }
        ...
        if (b)
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    if ("number" === typeof q[f] && 0 <= q[f]) { for (; m.length <= q[f];) Ga(a);
                        d(q[f], n) } else if ("number" === typeof q[f] && 0 > q[f]) d(m.length +
                    q[f], n);
    ...
    function S(a) {
        ...
        if ("string" === typeof a &&
            ...
            var c = function(a, b, f) { var g, j; if ("" !== f) { j = La(f); for (var i = 0, h = j.length; i < h; i++) { f = j[i].match(da);
                        g = j[i].match(X); if (f) { j[i] = j[i].replace(da, ""); "" !== j[i] && (a = a[j[i]]);
                            g = [];
                            j.splice(0, i + 1);
                            j = j.join("."); if (Array.isArray(a)) { i = 0; for (h = a.length; i < h; i++) g.push(c(a[i], b, j)) }
                            a = f[0].substring(1, f[0].length - 1);
                            a = "" === a ? g : g.join(a); break } else if (g) { j[i] = j[i].replace(X, "");
        ...
        if ("string" === typeof a && (-1 !== a.indexOf(".") || -1 !== a.indexOf("[") || -1 !== a.indexOf("("))) {
            var b = function(a, d, e) {
                ...
                for (var g, j, i = 0, h = e.length - 1; i < h; i++) {
                    ...
                    j =
                        e[i].match(X);
                    if (g) { e[i] = e[i].replace(da, "");
                        a[e[i]] = [];
                        f = e.slice();
                        f.splice(0, i + 1);
                        g = f.join("."); if (Array.isArray(d)) { j = 0; for (h = d.length; j < h; j++) f = {}, b(f, d[j], g), a[e[i]].push(f) } else a[e[i]] = d; return }
    ...
    function P(a) {
        ...
        if (-1 !== h.inArray(!1, b)) D(a, !1);
            ...
            if (0 !== i.length) {
                f =
                    j ? a.aoData.length : n;
                for (j = j ? 0 : g; j < f; j++) { var m = i[j],
                        q = a.aoData[m];
                    null === q.nTr && Ja(a, m); var s = q.nTr; if (0 !== e) { var G = d[c % e];
    ...
    function pb(a) {
        ...
        for (var f = a.sDom.split(""), g, j, i, n, m, q, k = 0; k < f.length; k++) {
            ...
            else if (0 !== l.ext.feature.length) { i = l.ext.feature;
    ...
    function ta(a, b, c) {
        ...
        var f, g = a.ajax,
            j = a.oInstance,
            i = function(b) { t(a, null, "xhr", [a, b, a.jqXHR]);
                c(b) };
        if (h.isPlainObject(g) && g.data) { f = g.data; var n = "function" === typeof f ? f(b, a) : f,
                b = "function" === typeof f && n ? n : h.extend(!0, b, n);
            delete g.data }
        n = { data: b, success: function(b) { var c = b.error || b.sError;
                c && K(a, 0, c);
                a.json = b;
                i(b) }, dataType: "json", cache: !1, type: a.sServerMethod, error: function(b, c) { var d = t(a, null, "xhr", [a, null, a.jqXHR]); - 1 === h.inArray(!0, d) && ("parsererror" == c ? K(a, 0, "Invalid JSON response", 1) : 4 === b.readyState && K(a, 0, "Ajax error", 7));
                D(a, !1) } };
        a.oAjaxData =
            b;
        t(a, null, "preXhr", [a, b]);
    ...
    function wb(a) {
        ...
        d.bSort && (h.each(k, function(a, b) { G.order.push({ column: b.col, dir: b.dir });
            s("iSortCol_" + a, b.col);
            s("sSortDir_" + a, b.dir) }), s("iSortingCols", k.length));
        b = l.ext.legacy.ajax;
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            i = function() { var b = !this.value ? "" : this.value;
    ...
    function Ab(a) {
        for (var b = l.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f <
            g; f++) { for (var j = [], i = 0, n = c.length; i < n; i++) e = c[i], d = a.aoData[e], b[f](a, d._aFilterData, e, d._aData, i) && j.push(e);
            c.length = 0;
            h.merge(c, j) }
    }
    ...
    function Bb(a) {
        ...
        for (f = a.aoData.length; d < f; d++)
            if (h =
                a.aoData[d], !h._aFilterData) { j = [];
                e = 0; for (g = b.length; e < g; e++) c = b[e], c.bSearchable ? (i = B(a, d, e, "filter"), m[c.sType] && (i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (wa.innerHTML = i, i = Zb ? wa.textContent : wa.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), j.push(i);
                h._aFilterData = j;
    ...
    function ia(a) {
        ...
        if (a.bInitialised) {
            ...
            T(a);
            e = y(a);
            if ("ssp" != e || g) "ajax" == e ? ta(a, [], function(c) { var f = ua(a, c); for (b = 0; b < f.length; b++) O(a, f[b]);
    ...
    function va(a, b) { a._bInitComplete = !0;
    ...
    function vb(a) {
        ...
        f.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({ fn: function(a) { if (d) { var b = a._iDisplayStart,
                        ...
                        i = m ? 1 : Math.ceil(h / i),
                        h = c(b, i),
                        k, m = 0; for (k = f.p.length; m < k; m++) Pa(a, "pageButton")(a, f.p[m], m, h, b, i) } else c.fnUpdate(a, e) }, sName: "pagination" }));
        return b
    }
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            h.each(sa(a, xa), function(b, c) { A = ba(a, b);
            ...
            I(B, L);
            I(function(a) { y.push(a.innerHTML);
                v.push(w(h(a).css("width"))) }, L);
            I(function(a, b) { if (h.inArray(a, $b) !== -1) a.style.width = v[b] }, o);
            h(L).height(0);
            u && (I(B, R), I(function(a) { z.push(a.innerHTML);
                x.push(w(h(a).css("width"))) }, R), I(function(a, b) { a.style.width = x[b] }, Q), h(R).height(0));
            I(function(a, b) {
            ...
            u && I(function(a, b) { a.innerHTML = '<div class="dataTables_sizing">' + z[b] + "</div>";
                a.childNodes[0].style.height = "0";
                a.childNodes[0].style.overflow = "hidden";
                a.style.width = x[b] }, R);
            if (p.outerWidth() < f) { Q = j.scrollHeight > j.offsetHeight || "scroll" == m.css("overflow-y") ? f + b : f; if (V && (j.scrollHeight > j.offsetHeight || "scroll" == m.css("overflow-y"))) t.width = w(Q - b);
    ...
    function Gb(a, b) { if (!a) return 0; var c = h("<div/>").css("width", w(a)).appendTo(b || H.body),
            d = c[0].offsetWidth;
        c.remove(); return d }
    ...
    function Y(a) {
        ...
        for (a = 0; a < n.length; a++) { i = n[a][0];
            f = e[i].aDataSort;
            b = 0; for (c = f.length; b < c; b++) g = f[b], j = e[g].sType || "string", n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1], e[g].asSorting)), d.push({ src: i, col: g, dir: n[a][1], index: n[a]._idx, type: j, formatter: l.ext.type.order[j + "-pre"] }) }
        return d
    }
    ...
    function ob(a) {
        ...
        if ("ssp" !=
            ...
            g === h.length ? i.sort(function(a, b) { var c, e, g, j, i = h.length,
                    k = f[a]._aSortData,
                    l = f[b]._aSortData; for (g = 0; g < i; g++)
    ...
    function Kb(a) { for (var b, c, d = a.aoColumns, e = Y(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) { c = d[f]; var j = c.asSorting;
    ...
    function ya(a) { var b = a.aLastSort,
            ...
            e = 0; for (f = d.length; e < f; e++) g = d[e].src, h(C(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 : 3)) }
        a.aLastSort = d }

    function Jb(a,
        b) { var c = a.aoColumns[b],
            d = l.ext.order[c.sSortDataType],
            e;
        d && (e = d.call(a.oInstance, a, b, ca(a, b))); for (var f, g = l.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; j < i; j++)
    ...
    function Aa(a) { var b = l.settings,
            a = h.inArray(a, C(b, "nTable")); return -1 !== a ? b[a] : null }

    function K(a, b, c, d) { c = "DataTables warning: " + (a ? "table id=" + a.sTableId + " - " : "") + c;
        d && (c += ". For more information about this error, please see http://datatables.net/tn/" + d); if (b) E.console && console.log && console.log(c);
    ...
    function Xa(a, b, c) { h(a).on("click.DT", b, function(b) { h(a).trigger("blur");
    ...
    var l = function(a) {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    var V = p.oFeatures,
                        e = function() {
                            ...
                            ya(p);
                            V.bSort && z(p, "aoDrawCallback", function() { if (p.bSorted) { var a = Y(p),
                                        b = {};
                                    h.each(a, function(a, c) { b[c.src] = c.dir });
                                    t(p, null, "order", [p, a, b]);
                                    Kb(p) } });
                            z(p, "aoDrawCallback", function() {
                                (p.bSorted || y(p) === "ssp" || V.bDeferRender) && ya(p) }, "sc");
        ...
        ka = function(a, b, c, d) { var e = [],
                f = 0,
                g = b.length; if (d !== k)
                for (; f < g; f++) a[b[f]][c] && e.push(a[b[f]][c][d]);
            else
                for (; f < g; f++) e.push(a[b[f]][c]); return e },
        Z = function(a, b) { var c = [],
                d;
        ...
        Tb = function(a, b) { if (Array.isArray(b))
    ...
    l.util = { throttle: function(a, b) { var c = b !== k ? b : 200,
                d, e; return function() { var b = this,
                    g = +new Date,
                    j = arguments; if (d && g < d + c) { clearTimeout(e);
                    e = setTimeout(function() { d = k;
                        a.apply(b, j) }, c) } else { d = g;
                    a.apply(b, j) } } }, escapeRegex: function(a) { return a.replace(cc, "\\$1") } };
    var A = function(a, b, c) { a[b] !== k && (a[c] = a[b]) },
        ...
        dc = function(a) {
            ...
            if (a) { if (a.nTable && a.oApi) return [a]; if (a.nodeName && a.nodeName.toLowerCase() === "table") { b = h.inArray(a, e); return b !== -1 ? [d[b]] : null } if (a && typeof a.settings === "function") return a.settings().toArray();
                typeof a === "string" ? c = h(a) : a instanceof h && (c = a) } else return [];
    ...
    h.extend(r.prototype, {
        ...
        iterator: function(a, b, c, d) {
            ...
            for (j = m.length; g < j; g++) {
                var t = new r(m[g]);
                if (b ===
                    "table") { f = c.call(t, m[g], g);
                    f !== k && e.push(f) } else if (b === "columns" || b === "rows") { f = c.call(t, m[g], this[g], g);
                    f !== k && e.push(f) } else if (b === "column" || b === "column-rows" || b === "row" || b === "cell") { o = this[g];
                    b === "column-rows" && (l = Da(m[g], u.opts));
                    i = 0; for (h = o.length; i < h; i++) { f = o[i];
                        f = b === "cell" ? c.call(t, m[g], f.row, f.column, g, i) : c.call(t, m[g], f, g, i, l);
                        f !== k && e.push(f) } }
            }
            if (e.length || d) { a = new r(m, a ? e.concat.apply([], e) : e);
                b = a.selector;
                b.rows = u.rows;
                b.cols = u.cols;
                b.opts = u.opts; return a }
            return this
        },
        lastIndexOf: x.lastIndexOf ||
            function(a, b) { return this.indexOf.apply(this.toArray.reverse(), arguments) },
        length: 0,
        map: function(a) { var b = []; if (x.map) b = x.map.call(this, a, this);
            else
                for (var c = 0, d = this.length; c < d; c++) b.push(a.call(this, this[c], c)); return new r(this.context, b) },
        ...
        if (Array.isArray(a))
            ...
            for (var e = a.split("."), f = Ub, g, j, c = 0, d = e.length; c < d; c++) {
                ...
                a: { i = 0; for (var k = f.length; i < k; i++)
                    ...
                    i = null }
                if (!i) { i = { name: g, val: {}, methodExt: [], propExt: [], type: "object" };
                    f.push(i) }
                if (c === d - 1) {
                    i.val =
                        b;
    ...
    r.registerPlural = u = function(a, b, c) { r.register(a, c);
    ...
    o("draw()", function(a) { return this.iterator("table", function(b) { if (a === "page") P(b);
            else { typeof a === "string" && (a = a === "full-hold" ? false : true);
                T(b, a === false) } }) });
    o("page()", function(a) {
        return a === k ? this.page.info().page : this.iterator("table",
            function(b) { Va(b, a) })
    });
    o("page.info()", function() { if (this.context.length === 0) return k; var a = this.context[0],
            b = a._iDisplayStart,
            c = a.oFeatures.bPaginate ? a._iDisplayLength : -1,
            d = a.fnRecordsDisplay(),
            e = c === -1; return { page: e ? 0 : Math.floor(b / c), pages: e ? 1 : Math.ceil(d / c), start: b, end: a.fnDisplayEnd(), length: c, recordsTotal: a.fnRecordsTotal(), recordsDisplay: d, serverSide: y(a) === "ssp" } });
    ...
    var Wb = function(a, b, c) { if (c) { var d = new r(a);
            d.one("draw", function() { c(d.ajax.json()) }) } if (y(a) == "ssp") T(a, b);
        else { D(a, true); var e = a.jqXHR;
            e && e.readyState !== 4 && e.abort();
            ta(a, [], function(c) { pa(a); for (var c = ua(a, c), d = 0, e = c.length; d < e; d++) O(a, c[d]);
                T(a, b);
                D(a, false) }) } };
    ...
    o("ajax.url()", function(a) { var b = this.context; if (a === k) { if (b.length === 0) return k;
    ...
    var bb = function(a, b, c, d, e) {
            ...
            i = 0;
            for (h = b.length; i < h; i++) { j = b[i] && b[i].split && !b[i].match(/[\[\(:]/) ? b[i].split(",") : [b[i]];
                m = 0; for (l = j.length; m < l; m++)(g = c(typeof j[m] === "string" ? j[m].trim() : j[m])) && g.length && (f = f.concat(g)) }
            a = v.selector[a];
        ...
        Da = function(a, b) {
            ...
            } else if (c == "index" || c == "original") { c = 0; for (d = a.aoData.length; c < d; c++)
                    if (j == "none") f.push(c);
                    else { e = h.inArray(c, g);
                        (e === -1 && j == "removed" || e >= 0 && j == "applied") && f.push(c) } }
            return f
        };
    o("rows()", function(a, b) {
        if (a === k) a = "";
        else if (h.isPlainObject(a)) { b = a;
            a = "" }
        var b = cb(b),
            c = this.iterator("table", function(c) {
                ...
                return bb("row", a, function(a) {
                        ...
                        if (a.nodeName) { var b = a._DT_RowIndex,
                                n = a._DT_CellIndex; if (b !== k) return i[b] && i[b].nTr === a ? [b] : []; if (n) return i[n.row] && i[n.row].nTr === a.parentNode ? [n.row] : [];
    ...
    u("rows().remove()", "row().remove()", function() {
        ...
        this.iterator("row", function(b, c, d) {
            ...
            for (h = e.length; g < h; g++) { i = e[g];
                m = i.anCells; if (i.nTr !== null) i.nTr._DT_RowIndex = g; if (m !== null) { i = 0; for (n = m.length; i < n; i++) m[i]._DT_CellIndex.row = g } }
    ...
    var eb = function(a, b) { var c = a.context; if (c.length)
                if ((c = c[0].aoData[b !== k ? b : a[0]]) && c._details) { c._details.remove();
                    c._detailsShow = k;
                    c._details = k } },
        Xb = function(a, b) {
            var c = a.context;
            if (c.length && a.length) {
                ...
                if (d._details) {
                    ...
                    if (C(g, "_details").length > 0) {
                        f.on("draw.dt.DT_details", function(a, b) { e === b && f.rows({ page: "current" }).eq(0).each(function(a) { a = g[a];
        ...
        if (a === true) this.child.show();
            ...
            var d = c[0],
                ...
                f = function(a, b) {
                    ...
                    else { c = h("<tr><td></td></tr>").addClass(b);
            ...
            c = this.iterator("table", function(c) {
                ...
                return bb("column", e, function(a) {
                    ...
                    if (k) switch (k[2]) {
                        case "visIdx":
                        case "visible":
                            b = parseInt(k[1], 10); if (b < 0) { var l = h.map(g, function(a, b) { return a.bVisible ? b : null }); return [l[l.length + b]] } return [ba(c, b)];
                        case "name":
    ...
    u("columns().visible()", "column().visible()", function(a, b) {
        var c = this,
            d = this.iterator("column", function(b, c) { if (a === k) return b.aoColumns[c].bVisible; var d = b.aoColumns,
                    j = d[c],
                    i = b.aoData,
                    n, m, l; if (a !== k && j.bVisible !== a) { if (a) { var o = h.inArray(true, C(d, "bVisible"), c + 1);
                        n = 0; for (m = i.length; n < m; n++) { l = i[n].nTr;
                            d = i[n].anCells;
                            l && l.insertBefore(d[c], d[o] || null) } } else h(C(b.aoData, "anCells", c)).detach();
                    j.bVisible = a } });
    ...
    o("cells()", function(a, b, c) {
        ...
        if (b === null || b === k) return this.iterator("table", function(b) {
            ...
            return bb("cell", d, function(a) {
                var c = typeof a ===
                    "function";
                if (a === null || a === k || c) { o = [];
                    u = 0; for (r = g.length; u < r; u++) { l = g[u]; for (t = 0; t < n; t++) { w = { row: l, column: t }; if (c) { v = f[l];
                                a(w, B(b, l, t), v.anCells ? v.anCells[t] : null) && o.push(w) } else o.push(w) } } return o }
        ...
        var d = c ? { page: c.page, order: c.order, search: c.search } : {},
            e = this.columns(b, d),
            f = this.rows(a, d),
            g, j, i, l, d = this.iterator("table", function(a, b) { var c = [];
                g = 0; for (j = f[b].length; g < j; g++) { i = 0; for (l = e[b].length; i < l; i++) c.push({ row: f[b][g], column: e[b][i] }) } return c }, 1),
    ...
    o("order.fixed()", function(a) { if (!a) { var b = this.context,
                b = b.length ? b[0].aaSortingFixed : k; return Array.isArray(b) ? { pre: b } : b } return this.iterator("table", function(b) { b.aaSortingFixed = h.extend(true, {}, a) }) });
    ...
    u("columns().search()", "column().search()", function(a, b, c, d) {
        return this.iterator("column",
            function(e, f) { var g = e.aoPreSearchCols; if (a === k) return g[f].sSearch; if (e.oFeatures.bFilter) { h.extend(g[f], { sSearch: a + "", bRegex: b === null ? false : b, bSmart: c === null ? true : c, bCaseInsensitive: d === null ? true : d });
    ...
    l.versionCheck = l.fnVersionCheck = function(a) { for (var b = l.version.split("."), a = a.split("."), c, d, e = 0, f = a.length; e < f; e++) { c = parseInt(b[e], 10) || 0;
            d = parseInt(a[e], 10) || 0; if (c !== d) return c > d } return true };
    ...
    l.tables = l.fnTables = function(a) { var b = false; if (h.isPlainObject(a)) { b = a.api;
            a = a.visible } var c = h.map(l.settings, function(b) { if (!a || a && h(b.nTable).is(":visible")) return b.nTable }); return b ? new r(c) : c };
    ...
    o("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            ...
            if (e != g.parentNode) { i.children("thead").detach();
                i.append(g) }
            if (j && e != j.parentNode) { i.children("tfoot").detach();
                i.append(j) }
            b.aaSorting = [];
            b.aaSortingFixed = [];
            ya(b);
            ...
            i[g]();
            k[g]();
            if (!a && c) { c.insertBefore(e, b.nTableReinsertBefore);
    ...
    h.each(["column", "row", "cell"], function(a, b) { o(b + "s().every()", function(a) { var d = this.selector.opts,
                e = this; return this.iterator(b, function(f, g, h, i, l) { a.call(e[b](g, b === "cell" ? h : d, b === "cell" ? d : k), g, h, i, l) }) }) });
                ...
                var g = a.oClasses,
                    ...
                    s = function(b, d) {
                        ...
                        for (u = d.length; k <
                            u; k++) {
                            r = d[k];
                            if (Array.isArray(r)) { t = h("<" + (r.DT_el || "div") + "/>").appendTo(b);
                                s(t, r) } else {
                                l = null;
                                m = r;
                                t = a.iTabIndex;
                                ...
                                if (l !== null) { t = h("<a>", { "class": g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": i[r], "data-dt-idx": o, tabindex: t, id: c === 0 && typeof r === "string" ? a.sTableId + "_" + r : null }).html(l).appendTo(b);
                                    Xa(t, { action: r }, w);
                                    o++ }
                            }
                        }
    ...
    var Ba = function(a, b, c, d) { if (a !== 0 && (!a || a === "-")) return -Infinity;
        b && (a = Qb(a, b)); if (a.replace) { c && (a = a.replace(c, ""));
            d && (a = a.replace(d, "")) } return a * 1 };
    ...
    l.render = { number: function(a, b, c, d, e) { return { display: function(f) { if (typeof f !== "number" && typeof f !== "string") return f; var g = f < 0 ? "-" : "",
                        h = parseFloat(f); if (isNaN(h)) return fb(f);
                    h = h.toFixed(c);
                    f = Math.abs(h);
                    h = parseInt(f, 10);
                    f = c ? b + (f - h).toFixed(c).substring(2) : ""; return g + (d || "") + h.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + f + (e || "") } } }, text: function() { return { display: fb, filter: fb } } };
