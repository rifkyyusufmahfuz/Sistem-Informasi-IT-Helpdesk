@foreach ($data_tindaklanjut as $data)
    @if ($list_software->where('id_permintaan', $data->id_permintaan)->isNotEmpty())
        ...
        <div class="modal fade" id="detail_tindaklanjut{{ $data->id_tindak_lanjut }}" tabindex="-1" role="dialog"
                        ...
                        <div id="detail_pegawai">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <input type="text" class="form-control" value="{{ $data->bagian_admin }}"
                                        disabled>
                                </div>

                                <div class="form-group col-sm-7">
                                    <label for="jabatan">Jabatan</label>
                                    <input type="text" class="form-control" value="{{ $data->jabatan_admin }}"
                                        disabled>
                                </div>
                            </div>
                    ...
                    <div class="modal-body" id="signature-pad">
                        ...
                        <div id="detail_pegawai">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-7">
                                    <label for="nama">Nama</label>
                                    <input type="text" class="form-control" value="{{ $data->nama_admin }}"
                                        disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="lokasi">Lokasi</label>
                                <input type="text" class="form-control" value="{{ $data->lokasi_admin }}"
                                    disabled>
                            </div>
                            <hr>
