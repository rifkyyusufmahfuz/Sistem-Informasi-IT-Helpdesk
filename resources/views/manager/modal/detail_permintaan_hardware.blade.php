            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="signature-pad">
                    <div id="detail_barang">
                        ...
                        <div class="form-group">
                            <label for="uraian_keluhan">Keluhan</label>
                            <textarea disabled class="form-control" id="uraian_keluhan" name="uraian_keluhan" rows="3">{{ $data->keluhan_kebutuhan }}</textarea>
                        </div>
                    </div>
                    <hr>
                    <div id="detail_pegawai">
                        <h6>Permintaan Diajukan Oleh:</h6>
                        <div class="row">
